...
Live combat uses all seventeen source levels and the four original projectile tiers. Shots travel at 5 or 9 tiles/s and keep the target position captured at launch, replacing the previous 16-tile/s tracking behavior. The original bodies, rooftop Wizards, particle artwork and sounds are verified and retained for live presentation integration; the scene still uses its authored image. The first 54 native villages and Graduation Ceremony (stage 58) have supported mechanics. Native progression prerequisites remain enforced, and Magic Practice still requires the campaign Shrink Trap. Combat version 34 expires incompatible playback while preserving old results and save version 4.
...
Source level progression, four-tier speed/nontracking behavior and portable replay reconstruction are integrated. Live presentation still needs body/defender registration, directional selection, attack-to-launch timing, original projectile graphics, particle clocks, audio, home gestures, construction/upgrades and reduced motion. Native projection, effect height/offset interpretation and complete particle-engine behavior remain unverified. The production-clone goal remains active.
