...
The opening is **Payback**, **Goblin Forest**, **Goblin Outpost**, **Rocky Fort**. Payback contains a special Tutorial Cannon. Goblin Huts appear at stage 2; their native unit arrays require interpretation separately from NPC-level alliance defenders. At stage 51 X-Bows appear. Later levels require Inferno Towers, Eagle Artillery, Scattershots, Spell Towers, Monoliths, Giant Dragon and M.O.M.M.A behavior. Some native levels contain more than the current replay limit of 400 buildings. Do not substitute a generic building, discard special defenders, clamp levels or rescale positions to make an unsupported level appear complete.
