...
| --- | --- |
| 10 | X-Bow 3×4, Bomb Tower 2×4, Giant Bomb 5×4, Skeleton Trap ×4 (its last implemented tier), Cannon 6×13, Archer Tower 7×13, Wall 275×11 |
| 11 | X-Bow 4×5, Wizard Tower 5×10, Cannon 7×15, Archer Tower 8×15, Air Sweeper 7, Wall 300×12 |
| 12 | Hidden Tesla 5×10, Air Bomb 6×6, Spring Trap 8×7, Cannon 17, Mortar 12 |
| 13 | Seeking Air Mine 7×4, Bomb 7×9, Spring Trap 9×8, Cannon 19, Wizard Tower 13 |
| 14 | Builder's Hut 4 (its last implemented level), Bomb 8×10, Giant Bomb 7×8, Air Bomb 7×9, Wall 325×15 |
| 15 | Cannon 21 and Archer Tower 21 — the last of both — Spell Factory 8, Army Camp 12 |
...
Ten entities stop below what the original tier permits. Each is asserted in `tests/townhall-tiers.test.ts` to be strictly below the source, so a gap can neither close nor widen unnoticed.
...
| Builder's Hut | level 8 | level 4 | only four original hut rows are reconstructed |
| Skeleton Trap | level 5 | level 4 | only four coffin tiers have reconstructed artwork and spawn counts |
| Inferno Tower, Eagle Artillery, Scattershot, Monolith, Spell Tower, Tornado Trap | TH10–TH15 | none | these families are implemented, but only for campaign battles |

The six late families are the largest gap: their combat, artwork and audio all exist and run in Goblin Map villages, but home and practice battles do not yet step late-family state. That is the next piece of work, not a missing implementation.
...
- **The Builder's Hut price.** The original sells the first hut for gems; this game keeps charging 12,000 gold for it, and takes the original prices only from level 2 upwards.
