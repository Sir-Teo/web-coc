...
- Rebuilding all 46 shipping images from the stored source files produces identical checksums, including the nine derived air-layer and spell files.
...
- The campaign matrix does not cover balloon-led or spell-supported attacks.
