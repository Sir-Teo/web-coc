...
| Set King level | Change the unlocked King's level within the current TH/Hero Hall cap. For level 110: unlock King, set TH18, max existing buildings, then set King level 110. |
