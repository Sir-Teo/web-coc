...
Remaining hero gaps: normal ore rewards (Star Bonus, Clan War and Hero Journey income), and exact combat/economy tuning. Dark elixir is earned from drills; campaign villages do not yet award dark loot. Existing simplified building counts, research caps, troop unlocks and army housing still need explicit progression tables.
