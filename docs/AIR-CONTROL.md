...
All seven HP/push/cost/time rows now drive retained villages and practice. The source TH10/11 requirements for levels 6/7 appear in Info; home purchase/upgrade ceilings are levels 2/3/4/5 at TH6/7/8/9. Higher retained levels are never clamped. High Pressure still requires Mortar 11 and Cannon 15; No Flight Zone still requires its garrison and Clan Castle. Supporting the Sweeper alone does not unlock either incomplete stage.
