...
The campaign now supports the first 54 original layouts and Graduation Ceremony (stage 58), whose source level-nine Wizard Towers are supported in version 34. Original stage dependencies remain enforced. Cross and Bows, Forest Outing and Skeleton Run retain all 59 original level-three mines and their 2,100 damage. Practice layouts remain local content. Source layouts and numerical records do not establish native combat parity or matchmaking balance.
