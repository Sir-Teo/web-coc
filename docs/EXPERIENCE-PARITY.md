...
| --- | --- | --- |
| Village building and editing | Partial | Placement, wall runs, collection, builders, upgrades, undo/redo, and layout slots work. Missing obstacle removal, decorations, wall-row selection/upgrades, exact placement conveniences, and the live game's full building catalog. |
...
| Army preparation | Partial | Instant/free preparation, weighted spell housing, and three presets work. Need full unlock progression, remaining troop/spell types, richer composition editing, army sharing, and live-game housing tables. Multiple barracks and factories remain a simplified legacy model. |
