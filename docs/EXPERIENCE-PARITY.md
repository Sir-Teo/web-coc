...
| --- | --- | --- |
| Village building and editing | Partial | Placement, wall runs, collection, builders, upgrades, undo/redo, and layout slots work. Trees and rocks now block building placement and support paid removal, cancellation, offline completion and persistent gem-cycle rewards. Missing obstacle regrowth, the full obstacle/decorations catalog, wall-row selection/upgrades, exact placement conveniences, and the live game's full building catalog. |
