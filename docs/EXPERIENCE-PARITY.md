...
| Progression and economy | Partial | Town Hall 1–8 building level ceilings and a progression browser are implemented. Dark elixir drills/storage support hero upgrades. Army Camp and the audited defenses/traps use explicit native progression tables. Barbarian and Archer levels 1–5 now use explicit native combat and research tables with troop-specific laboratory gates (see STARTER-TROOP-PROGRESSION.md). Other troop and building prices, timers, resource capacities and the full content/unlock catalog still need live-value validation. |
