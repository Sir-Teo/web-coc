...
| Troop and spell roster | Partial | Seven troops and three spells. The three supported spells now have native level 1–5 research, effects, hero modifiers and snapshotted replay levels (see SPELL-PROGRESSION.md). Still missing the complete elixir/dark-elixir roster, siege machines, donated units, super troops and later spell progression. |
