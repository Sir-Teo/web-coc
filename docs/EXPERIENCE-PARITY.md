...
| Defenses and traps | Partial | Cannons, archer towers, mortars, air defenses, Wizard Towers and four hidden trap types work. Cannon, Archer Tower and Mortar normal-mode damage, range and intervals now use explicit reference tables (see DEFENSE-PROGRESSION.md and MORTAR-PROGRESSION.md). Air Sweepers, Seeking Air Mines and concealed Hidden Teslas also work. Missing the remaining trap/defense catalog, complete level art, exact live statistics, and asynchronous defensive attacks. |
