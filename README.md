...
- Attack opens the native 90-village campaign catalog. Forty-nine layouts are supported; missing seasonal and later mechanics are labeled Coming soon. Campaign scouting and combat have **no time limit**, award no trophies and draw from a finite saved treasury. Practice retains 30-second scouting and a three-minute attack clock.
