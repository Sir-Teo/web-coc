...
The experience inventory and next implementation priorities are tracked in [docs/EXPERIENCE-PARITY.md](docs/EXPERIENCE-PARITY.md). Additional heroes, equipment, the full content roster, online defense/matchmaking, and clan systems are still missing; replays cover local attacks only, with portable file sharing and seeking, but no hosted sharing links, defense history, or playback beyond the explicitly supported combat versions 34–36. See [docs/REPLAYS.md](docs/REPLAYS.md).
