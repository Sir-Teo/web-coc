...
- Attack opens the native 90-village campaign catalog. The first 51 layouts are supported, including Invaders' original level-3 Bomb Tower and Goblin Picnic's native Santa Trap animation and five timed strikes; later missing mechanics are labeled Coming soon. Campaign scouting and combat have **no time limit**, award no trophies and draw from a finite saved treasury. Practice retains 30-second scouting and a three-minute attack clock. See [Santa Trap details and fidelity limits](docs/SANTA-TRAP.md).
