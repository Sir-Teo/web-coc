...
Original source art is integrated; native executable clock parity remains separate.
"""
import argparse
import csv
import hashlib
...
def build():
    ...
    native = dict(clientVersion='18.400.21', bundle=BUNDLE, baseUrl=BASE, sources=PINS,
        ...
        reconstruction=dict(liveIntegration=True, nativePlaybackVerified=False,
            ...
            timing='Source loading labels span 224 idle, 91 loading and 10 attack frames at 30 fps. Live playback fits loading into the existing 0.6-second preparation and starts the original attack segment at actual launch. Native time scaling and CoolDownOverride=4800 semantics remain unverified; see docs/AIR-CONTROL.md.',
            ...
            availability='All seven source levels are supported in retained villages and practice. The TH8 home cap remains level four; later campaign gates retain their unresolved weapons and garrisons.'))
