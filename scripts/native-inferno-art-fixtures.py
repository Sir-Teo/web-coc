#!/usr/bin/env python3
"""Independent source pixels for every retained Inferno export and clip frame."""
import argparse
import hashlib
import json
import math
...
def build():
    metadata = json.loads((ROOT / 'reference/inferno/art-source.json').read_text())
    ...
    cases = [dict(family='inferno', export=n, frame=0, controls={}) for n in graph['exports']]
    ...
    for start in range(0, len(cases), 160):
        ...
        category = 'inferno-art-' + str(start // 160 + 1)
        cell, width = 300, 2400
        ...
        folder = 'tests/fixtures/native-inferno-art/'
    ...
    documents['tests/fixtures/native-inferno-art/index.json'] = index
...
if __name__ == '__main__':
    ...
    print(('Verified' if args.check else 'Wrote')+' complete Inferno artwork witnesses')
